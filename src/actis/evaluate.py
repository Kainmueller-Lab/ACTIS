...
def evaluate_volume(gt_labels, pred_labels, outFn,
    ...
    for th in ths:
        ...
        metrics.addMetric(tblname, "AP_denoiseg", ap_denoiseg)
...
def calculate_scores(out_list, gt_list, fname, fg_thresh=0.8, seed_thresh=0.6, base_path=""):
    ...
    for pred_lab, gt in zip(label_list, gt_list):
        ...
        metric_dict["ap_50_denoiseg"].append(metrics_dict['confusion_matrix']['th_0_5']['AP_denoiseg'])
        metric_dict["f1_score"].append(metrics_dict['confusion_matrix']['th_0_5']['fscore'])
